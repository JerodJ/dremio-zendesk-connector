...
@SourceType(value = "ZendeskARP", label = "Zendesk",uiConfig = "zendesk-layout.json")
public class ZendeskConf extends AbstractArpConf<ZendeskConf> {
  private static final String ARP_FILENAME = "arp/implementation/zendesk-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.zendesk.ZendeskDriver";
